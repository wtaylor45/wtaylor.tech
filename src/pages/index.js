...
import zeus from "../images/zeus-min.jpeg"
import clog from "../images/clog.jpg"
import selfie from "../images/selfie-min.jpg"
      ...
      <AppContainer>
        ...
        <Container margin="-200px 0px 0px 0px">
          ...
          <Section title="Experience">
            For the past nearly 2 years, I have been working as a Senior
            Technical Consultant at Macedon Technologies. There, I have been
            designing, building, and delivering software to companies and
            government agencies. I have had the ability to lead small teams of
            developers, and rack up plenty of face time with the clients. It's
            been an incredible place to learn and grow.
            <br />
            <br />
            Previously, I worked at a seed stage start up called Cyber 20/20. As
            one of the first employees, I was tasked with building the front end
        ...
        >
          <Section title="Beyond Work">
            Living in America while having been born in France to a french
            mother and english father means my life has always revolved around
            travel. I've been to countless countries on 5 continents where I've
            had the ability to interact with so many incredible people.
            <br />
            <br />
            Aside from programming, my other passions in life are music and my
        ...
        <Container margin="-200px 0px 0px 0px">
          <Grid container direction="row" justify="center">
            <Grid item>
              <PhotoBox image={zeus}>
                Zeus looking like he's finally accepted that this is his life
                now
              </PhotoBox>
            </Grid>
            <Grid item>
              <PhotoBox image={selfie}>
                You have no idea how cold I was in this
              </PhotoBox>
            </Grid>
            <Grid item>
              <PhotoBox image={clog}>
                There's probably a sweet joke using 'Clog' that I could've made
                here
              </PhotoBox>
            </Grid>
          </Grid>
